...
WiFiUDP Udp;
/*
Create a constatnt variable for the speaker in the Arduino
 */
...
/*
 * Call alarm set function and check whether the packet received is true. If it is true, then turn on the alarm. 
 */
...
boolean alarmset(){
  //Function that checks whether a packet has been set regarding the status of the alarm. Whenver the alarm has been set, it displays true. Otherwise false.
}
